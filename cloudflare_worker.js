/**
 * 여기선 PWA - Gemini API Proxy Worker (v1.2 — maxOutputTokens 추가)
 * ------------------------------------------------
  ...
  async fetch(request, env) {
    ...
    const payload = {
      ...
      generationConfig: {
        ...
        // v1.2: 응답 길이 제한 → 책·노트북 같은 텍스트 많은 물건에서
        // Gemini가 본문 OCR로 빠져 응답이 잘리던 이슈 차단.
        // 분류 JSON은 100~200 토큰이면 충분, 512는 안전 마진.
        maxOutputTokens: 512,
      },
