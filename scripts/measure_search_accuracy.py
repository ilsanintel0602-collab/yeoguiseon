...
SAMPLE_QUERIES = [
    ...
    # 가구
    "의자", "책상", "장롱", "침대",
    # v5.89 확대: 일상 자주 검색어 100개 추가 (총 206개)
    # 페트·플라스틱 추가
    "치약", "치약통", "세제통", "세탁세제", "샴푸병", "린스병", "바디워시", "주방세제",
    "케찹통", "마요네즈통", "소스통", "고추장통", "된장통", "참기름병(플라스틱)",
    # 종이 추가
    "노트", "공책", "다이어리", "교과서", "참고서", "달력(종이)", "종이호일", "티슈박스",
    "휴지심", "키친타올심", "복사용지", "프린트물", "택배 상자",
    # 비닐 추가
    "김봉지", "라면스프봉지", "약봉지", "택배봉지", "쇼핑백 비닐", "지퍼백", "위생장갑",
    "랩", "비닐장갑",
    # 캔 추가
    "사이다캔", "콜라캔(빈)", "참치캔(빈)", "햄캔(빈)", "복숭아통조림", "참치(통조림)",
    # 유리 추가
    "잼병(유리)", "꿀병", "화장품 유리병", "향수병",
    # 음식물 추가
    "김치", "과일껍질", "사과 껍질", "양파 껍질", "감자 껍질", "생선뼈", "조개껍데기",
    "굴껍데기", "해산물 껍데기", "차 찌꺼기", "커피 찌꺼기",
    # 위험 추가
    "성냥", "폭죽", "온도계(수은)", "체온계", "농약",
    # 의류 추가
    "코트", "잠바", "패딩", "바지", "치마", "원피스", "티셔츠", "스웨터", "셔츠",
    "이불", "베개", "쿠션", "수건", "양탄자", "카펫",
    # 가구 추가
    "책장", "서랍장", "소파", "식탁", "옷장", "신발장",
    # 전자 추가
    "세탁기", "건조기", "식기세척기", "전자레인지", "오븐", "토스터", "전기밥솥", "전기포트",
    "헤어드라이어", "다리미", "프린터", "스피커",
    # 위생 추가
    "칫솔", "치실", "면도기", "면봉", "손톱깎이", "빗", "헤어밴드",
    # 기타 일상
    "우산", "자전거", "장난감", "퍼즐", "보드게임", "주사위", "공",
    "실리콘 케이스", "휴대폰 케이스", "보호필름",
]
